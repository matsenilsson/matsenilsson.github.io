...
This is a Directed Acyclical Graph (DAG) of the very simple scenario of X casuing Y.
...
#### Exercises
In the following seminar (REX002), we will simulate a third variable, Z, confounding the X $->$ Y relationship. Please try it beforehand. 
