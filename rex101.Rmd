...
dedicated to project. This directory will contain data files, codebooks, your 
...
Below some initial checks of teh imported data. Note from the output of `strd(d)` 
