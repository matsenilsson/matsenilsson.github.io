...
1. Simulate socioeconomic status (1 = high, 0 = low) as related to math performance and compliance
2. Do some checks of balance between treatment and control group in socio-economic
...
3. Some preliminary data analysis
