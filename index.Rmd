...
data sets (Script1a and 1b) and conducting a full data analysis of a 
...
Seminar notes are available on this website summarizing the topics discussed
...
**Method1** (see athena.su.se for schedule)  

Part 2 (seminars 101, 102, ...) run as satellite to the master-program course 
**Stat1** (see athena.su.se for schedule)
