...
### What is it? 
REX is a seminar series that introduces the statistical software R and its 
...
### What's in it?
At the REX seminars we work on scripts designed to solve given tasks: simulating
a data set (Script1) and conducting a full data analysis of a 
...
of each seminar. (Here are links to the final scripts:
<a href="script1_fin.R" target="_blank">Script1</a>, 
<a href="script2_fin.R" target="_blank">Script2</a>.)

Seminar notes are available 
on this website summarizing the topics discussed
at each seminar. If you find the content elementary, you probably don't need to
...
**Method1**:
Click here for [Schedule fall semester 2017](https://fastreg.psychology.su.se/KursWeb/ScheduleKronologisk.aspx?MomentID=71&termin=H17)

Part 2 (seminars 101, 102, ...) run as satellite to the master-program course 
**Stat1**:
Click here for [Schedule fall semester 2017](https://fastreg.psychology.su.se/KursWeb/ScheduleKronologisk.aspx?MomentID=61&termin=H17)
