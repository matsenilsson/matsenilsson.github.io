...
This code combines selected output in a vector called `my_result`. Use 
...
Output stored as object may be used as input to other functions. Here is a plot 
...
#### Exercises
How would you evaluate the observed differences in group medians of thresholds 
